...
export const MainFormBox = ({ children, sxProps, ...props }: CommonBoxProps) => (
  <Box sx={{ display: "flex", flexDirection: "column", height: "100%", position: "relative", ...sxProps }} {...props}>
    {children}
  </Box>
);

// 자동 높이 Box - 남은 공간 채우기 (flex: 1)
export const AutoBox = ({ children, minHeight = 400, sxProps, ...props }: CommonBoxProps) => (
